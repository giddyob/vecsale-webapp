    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container py-20 text-center max-w-md mx-auto">
          ...
          <p className="text-sm text-muted-foreground mb-6">Your deal has been purchased successfully. Check your email for confirmation.</p>
          <Link to="/" className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold bg-accent text-accent-foreground rounded-lg hover:opacity-90 transition-opacity">
            Continue Shopping
          </Link>
        </div>
        <Footer />
