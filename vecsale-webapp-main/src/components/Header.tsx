...
import vecsaleMobileLogo from "@/assets/vecsale_Logo__mobile_view.png";
        ...
        <div className="container flex items-center justify-between gap-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <a href="/" className="flex-shrink-0">
              {/* Laptop & tablet: use the full vecsale-logo */}
              <img alt="VecSale" className="hidden md:block" style={{ height: 40, width: "auto" }} src={vecsaleLogo} />
              {/* Mobile: use the mobile-view logo */}
              <img
                alt="VecSale"
                className="md:hidden"
                style={{ height: 32, width: "auto" }}
