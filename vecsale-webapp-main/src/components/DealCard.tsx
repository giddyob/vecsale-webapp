    ...
    >
      ...
      <div className="p-4 flex flex-col gap-1">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-xl font-bold" style={{ color: "hsl(var(--accent))" }}>
            GH₵{deal.currentPrice}
          </span>
          <span className="ml-auto text-xs font-bold text-white px-2 py-0.5 rounded-md" style={{ backgroundColor: "hsl(var(--badge-discount))" }}>
            -{deal.discount}%
          </span>
        </div>
      </div>
