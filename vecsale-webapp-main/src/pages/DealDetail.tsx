...
import { ArrowLeft, Heart, Star, MapPin, ShoppingCart, Share2, Shield, ChevronLeft, ChevronRight, X, ClipboardList } from "lucide-react";
              ...
              return (
                <>
                  ...
                  <div className="mt-4 flex flex-col gap-1">
                    ...
                    {/* Redemption Rules */}
                    {(() => {
                      const rules = activeSub?.redemption_rules || deal.redemptionRules;
                      ...
                      return (
                        <div className="mt-4 rounded-xl border border-border bg-secondary/60 p-4">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <p className="text-sm font-semibold text-foreground">Redemption Rules</p>
                          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-bold bg-discount text-discount-foreground px-2 py-0.5 rounded-md">
                            -{subDiscount}%
                          </span>
                        </div>
                      </button>
