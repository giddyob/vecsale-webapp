            ...
            <div className="container py-8 max-w-2xl">
                ...
                >
                    ...
                    <div
                        ...
                        style={{ background: `linear-gradient(135deg, ${ACCENT}, hsl(125 50% 35%))` }}
                    />
                    ...
                    {editingName ? (
                        <div className="flex items-center justify-center gap-2 mb-1">
                            ...
                            <button
                                ...
                                disabled={savingName}
                                className="text-accent-foreground rounded-lg p-1.5 disabled:opacity-50 transition-opacity hover:opacity-80 bg-accent"
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <span
                                    className="inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full text-accent-foreground bg-accent"
                                >
                ...
                >
                    ...
                    {quickLinks.map(({ to, icon, label, desc }, i) => (
                        ...
                        >
                            <div
                                className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-accent"
                                style={{ backgroundColor: "hsl(120 60% 41% / 0.1)" }}
                            >
                                {icon}
                            </div>
